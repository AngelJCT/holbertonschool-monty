#include "monty.h"
/**
 *pop_op-function to remove top element from stack
...
/**
 *swap_op-function to swap the top elements of the stack
 *@stack: pointer to struct
 *@line_number: number of line of opcode
 *@operators: pointer to line
 *@fd: file opened
...
/**
 *add_op-function to sum the two top elements of the stack
 *@stack: pointer to struct
 *@line_number: number of line of opcode
 *@operators: pointer to line
 *@fd: file opened
...
/**
 *nop_op-function to do nothing(literal, nothing)
 *@stack: pointer to struct
 *@line_number: number of line of opcode
 *@operators: pointer to line
 *@fd: file opened
